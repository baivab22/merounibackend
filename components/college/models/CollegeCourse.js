...
College.belongsToMany(Program, { through: CollegeCourse, foreignKey: "college_id", as: "courses" });
Program.belongsToMany(College, { through: CollegeCourse, foreignKey: "course_id", as: "colleges" });
