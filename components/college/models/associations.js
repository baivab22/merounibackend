...
College.belongsTo(University, { foreignKey: "university_id", as: "university" });
College.hasOne(CollegeAddress, { foreignKey: "college_id", as: "collegeAddress" });
...
CollegeAddress.belongsTo(College, { foreignKey: "college_id", as: "collegeAddressCollege" });
...
CollegeMember.belongsTo(College, { foreignKey: "college_id", as: "collegeMemberCollege" });

// CollegeAdmission Associations
CollegeAdmission.belongsTo(College, { foreignKey: "college_id", as: "collegeAdmissionCollege" });
